...
function getSteamPresence() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getPlayerSummaries()];
                case 1:
                    summaries = _a.sent();
                    presence = [];
...
function getPlayerSummaries() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    queryUrl = "?key=" + secrets_1.STEAM_API_KEY + "&steamids=" + getSteamIds() + "&format=json";
                    return [4 /*yield*/, superagent.get(baseUrl + queryUrl)];
                case 1:
                    response = _a.sent();
